...
import com.edusoho.yunketang.databinding.FragmentMyStudyVideoBinding;
...
@Layout(value = R.layout.fragment_my_study_video)
public class VideoStudyFragment extends BaseFragment<FragmentMyStudyVideoBinding> {

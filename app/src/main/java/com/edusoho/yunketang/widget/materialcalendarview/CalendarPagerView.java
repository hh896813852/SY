...
import com.edusoho.yunketang.widget.materialcalendarview.MaterialCalendarView.ShowOtherDates;
...
import static com.edusoho.yunketang.widget.materialcalendarview.MaterialCalendarView.SHOW_DEFAULTS;
import static com.edusoho.yunketang.widget.materialcalendarview.MaterialCalendarView.showOtherMonths;
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            int childHeightMeasureSpec = MeasureSpec.makeMeasureSpec(
                    (int)(measureTileHeight*0.65), // 缩小高度，配合MaterialCalendarView  1611行代码
                    MeasureSpec.EXACTLY
            );

...
public class CircleBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        barWidth = typedArray.getDimension(R.styleable.CircleBarView_bar_width, DensityUtil.dip2px(context, 10));
        typedArray.recycle();

        progressNum = 0;
        maxNum = 100;
        defaultSize = DensityUtil.dip2px(context, 100);
        mRectF = new RectF();
        ...
        progressPaint.setStrokeCap(Paint.Cap.SQUARE);//设置画笔为直角

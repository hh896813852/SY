...
import com.edusoho.yunketang.widget.materialcalendarview.format.ArrayWeekDayFormatter;
import com.edusoho.yunketang.widget.materialcalendarview.format.DayFormatter;
import com.edusoho.yunketang.widget.materialcalendarview.format.MonthArrayTitleFormatter;
import com.edusoho.yunketang.widget.materialcalendarview.format.TitleFormatter;
import com.edusoho.yunketang.widget.materialcalendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
        ...
        try {
            ...
            setLeftArrow(
                    a.getResourceId(
                            ...
                            R.drawable.icon_arrow_left_gray
                    )
            );
            setRightArrow(
                    a.getResourceId(
                            R.styleable.MaterialCalendarView_mcv_rightArrowMask,
                            R.drawable.icon_arrow_right_gray
                    )
            );
    ...
    public void setHeaderTextAppearance(int resourceId) {
        ...
        title.setTextColor(ContextCompat.getColor(getContext(), R.color.text_white));
    }
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        int measuredHeight = (int) (measureTileHeight * 0.7) * viewTileHeight;// 缩小高度，配合MCalendarPagerView 269行代码

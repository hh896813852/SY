package com.edusoho.yunketang.utils.html;
...
public class MyHtmlTagHandler implements Html.TagHandler {
    ...
    public void endEndHandleTag(String tag, Editable output, XMLReader xmlReader) {
        ...
        if (!TextUtils.isEmpty(size)) {
            output.setSpan(new AbsoluteSizeSpan(DensityUtil.dip2px(SYApplication.getInstance(), Integer.parseInt(size))), startIndex, endIndex, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
